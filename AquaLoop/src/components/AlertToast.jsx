                    ...
                    >
                        ...
                        <div className="flex-1 min-w-0">
                            <div className="flex items-center gap-2 mb-1">
                                <span className={`font-heading text-[10px] uppercase tracking-widest font-bold ${isCritical ? "text-red-400" : "text-amber-400"}`}>
                                    {alert.severity}
                                </span>
                            ...
                            <p className="font-heading text-sm font-semibold">
                                {alert.metric} spike: <span className="font-data">{alert.value}{alert.unit}</span>
                            </p>
