...
export default function Analytics() {
  ...
  const { history, stats } = useMemo(() => {
    ...
    switch (selectedRange) {
      ...
      default:
        msRange = 24 * 60 * 60 * 1000;
        break; // Default to 24h if something goes wrong
    }
  ...
  const pieData = [
    {
      name: "High-grade Reuse",
      value: stats.classVolumes.min,
      color: "#60A5FA",
    }, // blue-400
            ...
            <div className="flex flex-wrap gap-2">
              {availableProcesses.map((pid) => (
                <button
                  ...
                  className={`px-4 py-2 rounded-full font-heading text-sm font-semibold transition-colors ${
                    selectedProcess === pid
                ...
                >
                  {pid === "processA"
                    ? "Lithography Rinse — LIVE"
                    : pid === "processB"
                      ? "Etch Clean — SIMULATED"
            ...
            <ChartCard title="Sensor Telemetry">
              <ResponsiveContainer width="100%" height="100%">
                ...
                >
                  ...
                  {/* LEFT axis — TDS (0–500) */}
                  {/* LEFT — TDS: auto domain with padding */}
                  <YAxis
                    yAxisId="tds"
                    orientation="left"
                    domain={["auto", "auto"]} // ← change this
                    stroke="#60A5FA"
                    tick={{
                      fontSize: 9,
                  ...
                  <tbody className="font-data text-sm">
                    {[...history]
                      ...
                      .map((row, i) => (
                        ...
                        >
                          <td className="py-4 px-2 font-bold text-accent">
                            {row.batchNo}
                          </td>
